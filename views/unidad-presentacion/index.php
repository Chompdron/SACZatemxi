        ...
        'columns' => [
            ...
            [ 'attribute' => 'clave',
              ...
              'value'=>function($model){
                ...
                return  Html::a("Actualizar",['/cliente/update','id'=>$model->UnidadPresentacionID],["options"=>["data-pjax"=>"0"]]).
                        '<a href="'.Url::to(['/cliente/view','id'=>$model->UnidadPresentacionID]).'"  data-pjax="0">'." Ver".'</a>';
              }
            ],
